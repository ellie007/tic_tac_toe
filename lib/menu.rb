class Menu
  ...
  attr_accessor :size, :dimension_response, :game_type_response, :player_one_name, :player_two_name, :player_one_token, :player_two_token, :turn_response
  ...
  def dimension
    print DIMENSION
    @dimension_response = gets.chomp.to_i
  end
